...
* **Inteligência Artificial:** Aprendizado de Máquina (Machine Learning), Redes Neurais, Processamento de Linguagem Natural (NLP).
* **Engenharia de Software:** Arquitetura de Microserviços, Teste de Software, Metodologias Ágeis (Scrum/Kanban).
* **Sistemas Distribuídos:** Computação em Nuvem (Cloud Computing), Serverless, Big Data.
